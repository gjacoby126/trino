...
import static io.trino.plugin.kaldb.KalDBQueryRunner.createKalDBQueryRunner;
...
public abstract class BaseKalDBConnectorTest
        extends BaseConnectorTest
{
    private final String catalogName;
   //private KalDBServer elasticsearch;
    protected RestHighLevelClient client;

    BaseKalDBConnectorTest(String catalogName)
    {
            ...
            throws Exception
    {
        ...
        HostAndPort address = HostAndPort.fromParts("localhost", 8081);
        HostAndPort dataSetAddress = HostAndPort.fromParts("localhost", 8083);
        client = new RestHighLevelClient(RestClient.builder(new HttpHost(address.getHost(), address.getPort())));

        return createKalDBQueryRunner(
                address,
                dataSetAddress,
                TpchTable.getTables(),
                ImmutableMap.of(),
            ...
            throws IOException
    {
        ...
        throw new UnsupportedOperationException("index not yet implemented -- need to use KalDB dataset library");
