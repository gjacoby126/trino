 ...
 */
package io.trino.plugin.kaldb.decoders;

import com.fasterxml.jackson.annotation.JsonCreator;
import com.fasterxml.jackson.annotation.JsonProperty;
import io.trino.plugin.kaldb.DecoderDescriptor;
        ...
        implements Decoder
{
    ...
    /*
    Copied from ElasticSearch's Trino plugin ScanQueryPageSource. KalDB doesn't support
    paging yet, so we can't implement our own paging source, but we need this bit of
    deserialization logic that lives in ES's.
     */
