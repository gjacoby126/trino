        ...
        implements Closeable
{
    ...
    public BackpressureRestHighLevelClient(RestClientBuilder restClientBuilder, KalDBConfig config, TimeStat backpressureStats)
    {
    ...
    public MultiSearchResponse msearch(MultiSearchRequest searchRequest, Header... headers)
            throws IOException
    {
        ...
        return executeWithRetries(() -> delegate.msearch(searchRequest, builder.build()));
    }
