        ...
        implements ConnectorTableHandle
{
    ...
    public KalDBTableHandle(Type type, String schema, String index, Optional<String> query)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        KalDBTableHandle that = (KalDBTableHandle) o;
