...
import io.trino.plugin.kaldb.client.IndexMetadata.DateTimeType;
import io.trino.plugin.kaldb.client.IndexMetadata.ObjectType;
import io.trino.plugin.kaldb.client.IndexMetadata.PrimitiveType;
import io.trino.plugin.kaldb.client.IndexMetadata.ScaledFloatType;
import io.trino.plugin.kaldb.client.KalDBClient;
import io.trino.plugin.kaldb.decoders.ArrayDecoder;
import io.trino.plugin.kaldb.decoders.BigintDecoder;
import io.trino.plugin.kaldb.decoders.BooleanDecoder;
import io.trino.plugin.kaldb.decoders.DoubleDecoder;
import io.trino.plugin.kaldb.decoders.IntegerDecoder;
import io.trino.plugin.kaldb.decoders.IpAddressDecoder;
import io.trino.plugin.kaldb.decoders.RawJsonDecoder;
import io.trino.plugin.kaldb.decoders.RealDecoder;
import io.trino.plugin.kaldb.decoders.RowDecoder;
import io.trino.plugin.kaldb.decoders.SmallintDecoder;
import io.trino.plugin.kaldb.decoders.TimestampDecoder;
import io.trino.plugin.kaldb.decoders.TinyintDecoder;
import io.trino.plugin.kaldb.decoders.VarbinaryDecoder;
import io.trino.plugin.kaldb.decoders.VarcharDecoder;
import io.trino.plugin.kaldb.ptf.RawQuery.RawQueryFunctionHandle;
...
import static io.trino.plugin.kaldb.KalDBTableHandle.Type.SCAN;
        ...
        implements ConnectorMetadata
{
    ...
    @Override
    public KalDBTableHandle getTableHandle(ConnectorSession session, SchemaTableName tableName)
    {
    ...
    public ColumnMetadata getColumnMetadata(ConnectorSession session, ConnectorTableHandle tableHandle, ColumnHandle columnHandle)
    {
        ...
        KalDBColumnHandle column = (KalDBColumnHandle) columnHandle;
        ...
        for (ConnectorExpression expression : expressions) {
            if (expression instanceof Call call) {
                if (isSupportedLikeCall(call)) {
                    ...
                    KalDBColumnHandle column = (KalDBColumnHandle) constraint.getAssignments().get(variableName);
    ...
    {
        Optional<Character> escapeChar = escape.map(KalDBMetadata::getEscapeChar);
    ...
    private static boolean isPassthroughQuery(KalDBTableHandle table)
    {
